...
const MOCK_COURSES: Course[] = [
  ...
  },
  {
    ...
    type: 'course',
    thumbnail: '/thumbnails/image6.png', // replace with actual path
  },
]
      ...
      <style>{`
        * { box-sizing: border-box; }
        ...
        @media (max-width: 600px) {
          .catalog-card { padding: 1.5rem 1rem 1.75rem; }
          .catalog-card h1 { font-size: 1.375rem; }
          .catalog-grid { grid-template-columns: 1fr 1fr; gap: 0.875rem; }
        }
            ...
            <div className="catalog-grid">
              {filtered.map((course) => (
                <Link
                  ...
                  to={RouteBuilder.course(course.id)}
                >
