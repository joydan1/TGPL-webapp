...
export default function AdminSignupPage() {
  ...
  // No `role` state here — admin signup only ever creates admin accounts,
      ...
      <>
        ...
        <div style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', background: 'var(--grey)', padding: '1rem' }}>
          <div style={{ background: 'var(--white)', borderRadius: 'var(--radius-lg)', padding: '3rem 2.5rem', maxWidth: 440, width: '100%', textAlign: 'center', boxShadow: 'var(--shadow-sm)' }}>
            ...
            <Link to={ROUTES.ADMIN_LOGIN} style={{ display: 'inline-block', color: 'var(--primary-500)', fontWeight: 600, textDecoration: 'none', fontSize: '0.9rem' }}
  ...
  return (
    <>
      ...
      <div className="signup-page">
       <AuthHero
  imageUrl="/admin-hero.png"
  heading={<>Manage TGPL,<br />Keep projects on track,<br />one task at a time!</>}
/>
        ...
        <div className="signup-form-panel">
          ...
          <div className="signup-card">
            ...
            {/* No role toggle here — admin is the only role this form creates */}
  ...
  I agree to the{' '}
  <a href={`${ROUTES.TERMS}?from=admin`} target="_blank" rel="noopener noreferrer">Terms of Service</a>
  {' '}and{' '}
  <a href={`${ROUTES.PRIVACY}?from=admin`} target="_blank" rel="noopener noreferrer">Privacy Policy</a>
</label>
                </div>
            ...
            <div className="signup-footer">
              <p>or</p>
              <p>Already have an account? <Link to={ROUTES.ADMIN_LOGIN} style={{ fontWeight: 600 }}>Log in</Link></p>
            </div>
          </div>
