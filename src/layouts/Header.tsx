...
const Header: React.FC = () => {
  ...
  const scrollToSection = (sectionId: string) => {
    ...
    if (el) {
      // Offset for sticky header height (~72px)
  ...
  return (
    ...
    >
      ...
      >
          ...
          {navLinks.map((link) => {
            ...
            return (
              <button
                ...
                onMouseEnter={(e) => {
                  if (!active) e.currentTarget.style.color = 'var(--primary-500)'
                }}
                onMouseLeave={(e) => {
                  if (!active) e.currentTarget.style.color = 'var(--black)'
                }}
              >
                {link.label}
              </button>
        ...
        >
          {/* Login scrolls to contact as a proxy, or you can remove it */}
          <button
            ...
            return (
              <button
                ...
                style={{
                  ...
                  fontWeight: 500,
                  padding: '0.5rem 0',
                  borderBottom: active ? '2px solid var(--primary-500)' : 'none',
                }}
              >
                {link.label}
              </button>
