    ...
    >
      ...
      >
        ...
        <div>
          ...
          <p style={{ fontSize: '0.9rem', lineHeight: 1.6, marginBottom: '1rem', color: '#b0c4de' }}>
        ...
        <div>
          ...
          >
            <li style={{ display: 'flex', alignItems: 'center', gap: '0.75rem' }}>
              ...
              <a
                href="mailto:theglobalprojectleaders@gmail.com"
                style={{
                  color: '#b0c4de',
                  textDecoration: 'none',
                  fontSize: '0.95rem',
            ...
            <li style={{ display: 'flex', alignItems: 'center', gap: '1rem', marginTop: '0.5rem' }}>
              <a
                href="https://instagram.com/theglobalprojectleaders"
                target="_blank"
            ...
            <li style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}>
              <a
                href="https://linkedin.com/company/the-global-project-leaders"
                target="_blank"
                rel="noopener noreferrer"
                style={{
                  color: '#b0c4de',
